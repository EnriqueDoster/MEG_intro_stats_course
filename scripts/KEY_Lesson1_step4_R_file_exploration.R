...
sample_metadata <- read.table('./data/sample_metadata.csv', header=T, sep=',', row.names = 1)
...
taxa <- read.table("data/Exported_16S_qiime2_results/taxonomy.tsv", header=T, row.names=1, sep='\t')
